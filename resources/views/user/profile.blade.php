    ...
    <div class="col-lg-12">
        <p>
            ...
            <div class="row">
                ...
                <div class="row form-group"><div class="col-sm-2">Email</div><div class="col-sm-10"><input type="text" value="{{ Auth::user()->email }}" name="name" class="form-control" disabled=""></div></div>
                </div>
            </div>
      </div>
      <p></p>
